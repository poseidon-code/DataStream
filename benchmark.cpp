...
int main() {
    ...
    DataStream::Stream<DataStream::Mode::Output, std::endian::little> ds9(b9);
    ...
    DataStream::Stream<DataStream::Mode::Output, std::endian::little> ds10(b10);
